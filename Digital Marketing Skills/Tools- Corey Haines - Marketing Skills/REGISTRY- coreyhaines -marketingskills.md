...
Read integration guides - Detailed setup and common operations in `integrations/`
---
Tool Index
...
adobe-analytics	Analytics	✓	-	✓	✓	adobe-analytics.md
plausible	Analytics	✓	-	✓	-	plausible.md
google-search-console	SEO	✓	-	✓	✓	google-search-console.md
semrush	SEO	✓	-	✓	-	semrush.md
ahrefs	SEO	✓	-	✓	-	ahrefs.md
dataforseo	SEO	✓	-	✓	✓	dataforseo.md
keywords-everywhere	SEO	✓	-	✓	-	keywords-everywhere.md
rankparse	SEO	✓	✓	✓	-	rankparse.md
clearbit	Data Enrichment	✓	-	✓	✓	clearbit.md
apollo	Data Enrichment	✓	-	✓	-	apollo.md
zoominfo	Data Enrichment	✓	✓	✓	-	zoominfo.md
clay	Data Enrichment	✓	✓	✓	-	clay.md
supermetrics	Data Aggregation	✓	✓	✓	-	supermetrics.md
coupler	Data Aggregation	✓	✓	✓	-	coupler.md
hubspot	CRM	✓	-	✓	✓	hubspot.md
salesforce	CRM	✓	-	✓	✓	salesforce.md
close	CRM	✓	-	✓	-	close.md
stripe	Payments	✓	✓	✓	✓	stripe.md
paddle	Payments	✓	-	✓	✓	paddle.md
rewardful	Referral	✓	-	✓	-	rewardful.md
tolt	Referral	✓	-	✓	-	tolt.md
dub-co	Links	✓	-	✓	✓	dub-co.md
mention-me	Referral	✓	-	✓	-	mention-me.md
partnerstack	Affiliate	✓	-	✓	-	partnerstack.md
mailchimp	Email	✓	✓	✓	✓	mailchimp.md
customer-io	Email	✓	-	✓	✓	customer-io.md
sendgrid	Email	✓	-	✓	✓	sendgrid.md
resend	Email	✓	✓	✓	✓	resend.md
sequenzy	Email	✓	✓	✓	-	sequenzy.md
nitrosend	Email	✓	✓	-	-	nitrosend.md
kit	Email	✓	-	✓	✓	kit.md
beehiiv	Newsletter	✓	-	✓	-	beehiiv.md
klaviyo	Email/SMS	✓	-	✓	✓	klaviyo.md
postmark	Email	✓	-	✓	✓	postmark.md
brevo	Email/SMS	✓	-	✓	✓	brevo.md
activecampaign	Email/CRM	✓	-	✓	✓	activecampaign.md
twilio	SMS/Voice	✓	-	✓	✓	twilio.md
plivo	SMS/Voice	✓	-	-	✓	plivo.md
postscript	SMS	✓	-	-	-	postscript.md
attentive	SMS	✓	-	-	-	attentive.md
audiencetap	SMS/Email	✓	-	-	-	audiencetap.md
hunter	Email Outreach	✓	-	✓	-	hunter.md
snov	Email Outreach	✓	-	✓	-	snov.md
truelist	Email Verification	✓	✓	-	✓	truelist.md
github	Developer Intent	✓	-	✓	✓	github.md
firecrawl	Site Scraping	✓	✓	-	✓	firecrawl.md
browserbase	Site Scraping	✓	✓	-	✓	browserbase.md
lemlist	Email Outreach	✓	-	✓	-	lemlist.md
instantly	Email Outreach	✓	-	✓	-	instantly.md
google-ads	Ads	✓	✓	✓	✓	google-ads.md
meta-ads	Ads	✓	-	✓	✓	meta-ads.md
linkedin-ads	Ads	✓	-	✓	-	linkedin-ads.md
tiktok-ads	Ads	✓	-	✓	✓	tiktok-ads.md
zapier	Automation	✓	✓	✓	✓	zapier.md
hotjar	CRO	✓	-	✓	-	hotjar.md
optimizely	A/B Testing	✓	-	✓	✓	optimizely.md
calendly	Scheduling	✓	-	✓	-	calendly.md
savvycal	Scheduling	✓	-	✓	-	savvycal.md
typeform	Forms	✓	-	✓	✓	typeform.md
intercom	Messaging	✓	-	✓	✓	intercom.md
outreach	Sales Engagement	✓	✓	✓	-	outreach.md
crossbeam	Partner Ecosystem	✓	✓	✓	-	crossbeam.md
introw	Partner Ecosystem	-	✓	-	-	introw.md
pendo	Product Analytics	✓	-	✓	-	pendo.md
similarweb	Competitive Intelligence	✓	-	✓	-	similarweb.md
exa	AI Search	✓	✓	✓	✓	exa.md
firehose	Competitive Intelligence	✓	-	-	-	firehose.md
sparktoro	Audience Research	-	-	-	-	sparktoro.md
rb2b	Visitor Identification	✓	-	-	-	rb2b.md
gong	Revenue Intelligence	✓	-	-	-	gong.md
airops	AI Content	✓	-	✓	-	airops.md
buffer	Social	✓	-	✓	-	buffer.md
wistia	Video	✓	-	✓	-	wistia.md
heygen	Video	✓	✓	-	✓	heygen.md
hyperframes	Video	-	-	✓	✓	hyperframes.md
trustpilot	Reviews	✓	-	✓	-	trustpilot.md
g2	Reviews	✓	-	✓	-	g2.md
onesignal	Push	✓	-	✓	✓	onesignal.md
demio	Webinar	✓	-	✓	-	demio.md
livestorm	Webinar	✓	-	✓	-	livestorm.md
shopify	Commerce	✓	-	✓	✓	shopify.md
wordpress	CMS	✓	-	✓	✓	wordpress.md
webflow	CMS	✓	-	✓	✓	webflow.md
sanity	Headless CMS	✓	-	✓	✓	sanity.md
contentful	Headless CMS	✓	-	✓	✓	contentful.md
strapi	Headless CMS	✓	-	✓	✓	strapi.md
composio	Integration Layer	✓	✓	✓	✓	composio.md
cogny	Integration Layer	-	✓	-	-	cogny.md
---
By Category
Analytics
...
Agent recommendation: Shopify for e-commerce. Webflow for marketing sites. WordPress for blogs. For headless CMS: Sanity for developer-flexible content, Contentful for enterprise multi-locale, Strapi for self-hosted/budget-conscious. See headless CMS guide for selection criteria.
---
CLI Tools
...
Composio provides managed OAuth and pre-built connectors for 500+ tools via a single MCP server. It adds MCP access to tools that don't have native MCP servers, including HubSpot, Salesforce, Meta Ads, LinkedIn Ads, Google Sheets, Slack, Notion, and more.
Setup: `npx @composio/mcp@latest setup`
Quick start: See tools/composio/README.md
Marketing tool mapping: See tools/composio/marketing-tools.md
...
Cogny Integration
Cogny is a hosted MCP gateway focused on marketing channels — one federated MCP URL with managed OAuth across every channel you've connected. Narrower than Composio (marketing-only) and useful when you want SEO, paid social, and privacy-friendly analytics behind a single MCP login.
Setup: connect channels at cogny.com, then in Claude.ai go to Settings → Connectors → Add custom connector and paste `https://app.cogny.com/mcp`
...
Read ga4.md for web analytics
Read segment.md if routing to multiple tools
Launching a referral program
Read rewardful.md or tolt.md for Stripe-based programs
Read dub-co.md for link tracking
Setting up email automation
Read customer-io.md for behavior-based automation
Read resend.md for transactional email
Running email outreach for backlinks
Read hunter.md for finding emails
Read lemlist.md or instantly.md for sending campaigns
Running paid ads
Read google-ads.md for search campaigns
Read meta-ads.md for social campaigns
